                    ...
                    isLogin ? (
                        <>
                            ...
                            <form style={{ width: "100%", marginTop: "1rem" }} onSubmit={handleLogin}>
                                ...
                                <Button variant='contained' color='primary' type='submit' sx={{ marginTop: "1rem" }} fullWidth>Login</Button>
                            ...
                            <form style={{ width: "100%", marginTop: "1rem" }} onSubmit={handleSignUp}>
                                ...
                                <Button variant='contained' color='primary' type='submit' sx={{ marginTop: "1rem" }} fullWidth>Sign up</Button>
